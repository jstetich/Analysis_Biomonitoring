...
We are only interested in "most recent" data that relates to the recent past.
Here we restrict ourselves to sites from the last ten years of available data.
